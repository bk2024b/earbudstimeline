...
// Technologies de la lignée = "Entity Bridges" du design bible (liens
// inline en pilule vers une couche de metadata plus profonde).
function Chip({ href, label, icon: Icon }) {
  const content = (
    <span className="entity-bridge">
